...
<div class="h-screen grid grid-rows-[auto_1fr]">
    <div class="w-full text-center h-14 border-b border-gray-200 dark:border-gray-700">
        <h1 class="text-xl inline dark:text-purple-300 text-purple-950 font-bold hover:dark:text-yellow-500 hover:text-yellow-700">
            <a href="/" title="AwpakAI home"><img class="h-4 inline mb-0.5 mr-1.5" src="/favicon.svg" alt="AwpakAI logo"/>AwpakAI</a>
        </h1>
